...
import com.cuncisboss.shoppinglist.util.Event
...
class ShoppingViewModel @ViewModelInject constructor(
    ...
    private val _images = MutableLiveData<Event<Resource<Image.Response>>>()
    val images: LiveData<Event<Resource<Image.Response>>> = _images
